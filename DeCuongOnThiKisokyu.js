...
const questions = [
    ...
    {
        id: 58,
        jp: "この ひょうしき が あるところ では かんでんの きけん は ありません。",
        ...
        answer: "ꓫ",
        keywords: ["ひょうしき", "かんでん", "きけん", "hyoushiki", "kanden", "kiken", "biển báo", "điện giật", "nguy cơ"],
    ...
    },
    {
        ...
        answer: "ꓫ",
        keywords: ["ひょうしき", "はいる", "hyoshiki", "hairu", "biển báo", "vào"],
    ...
    },
    {
        ...
        answer: "ꓫ",
        keywords: ["ひょうしき", "たばこ", "すう", "hyoshiki", "tabako", "suu", "biển báo", "thuốc lá", "hút"],
        image: "hinh anh 100 cau/hi.jpg"
    },
    {
        id: 63,
        jp: "この ひょうしき が あるところ では たばこ を すってはいけません。",
        romaji: "Kono hyoshiki ga arutokoro dewa tabako wo sutte wa ikemasen.",
        meaning: "Không được hút thuốc ở chỗ có biển báo này.",
        answer: "◯",
        keywords: ["ひょうしき", "たばこ", "すう", "hyoshiki", "tabako", "suu", "biển báo", "thuốc lá", "hút"],
    ...
    {
        id: 64,
        jp: "けんちくこうじょうシート に は ぼうえん かこう を しなくて も よいです。",
        romaji: "Kenchikukoujiyou shiito niwa bouen kakouwo shinakutemo yoidesu.",
    ...
    },
    {
        ...
        answer: "◯",
        keywords: ["じぬい", "きじ", "おもて", "あわせる", "ぬう", "jinui", "kiji", "omote", "awaseru", "nuu", "may ghép", "mặt trái", "tấm vải", "lộn ra mặt phải"],
        image: null
    },
    {
        id: 66,
        jp: "こうしゅうはウエルダー は ねっぷう をつかった ようちゃく き です。",
        romaji: "Koushu-ha-ueruda- wa neppuuwo tsukatta youchaku ki desu.",
        meaning: "Máy hàn cao tần là máy hàn nóng chảy sử dụng khí nóng",
        answer: "ꓫ",
        keywords: ["こうしゅうはウエルダー", "ねっぷう", "ようちゃく", "koushu-ha-ueruda-", "neppuu", "youchaku", "máy hàn cao tần", "khí nóng", "hàn nóng chảy"],
        image: null
    },
    {
        id: 67,
        jp: "ようちゃく かこうを したときは めどめしょりをします。",
        romaji: "Youchaku kakou wo shitatokiwa mejimeshori wo shimasu.",
        meaning: "Khi gia công hàn nóng chảy, phải xử lý chống rò.",
        answer: "ꓫ",
        keywords: ["ようちゃく", "かこう", "めどめしょり", "youchaku", "kakou", "mejimeshori", "hàn nóng chảy", "gia công", "xử lý chống rò"],
        image: null
    },
    {
        id: 68,
        jp: "ナイロンや ビニロンは かがくせ んい です。",
        romaji: "Naironya binironwa kagakusen i desu.",
        meaning: "Nylon và Vinylon là sợi hóa học",
        answer: "◯",
        keywords: ["ナイロン", "ビニロン", "かがくせんい", "nairon", "biniron", "kagakusen i", "nylon", "vinylon", "sợi hóa học"],
        image: null
    },
    {
        id: 69,
        jp: "アイレットリングの 25ばんは 30ばんより おおきい です。",
        romaji: "Airettoringu no nijuugoban wa sanjuuban yori ookii desu.",
        meaning: "Khoen bọc lỗ số 25 lớn hơn khoen số 30",
        answer: "ꓫ",
        keywords: ["アイレットリング", "25ばん", "30ばん", "おおきい", "airettoringu", "nijuugoban", "sanjuuban", "ookii", "khoen bọc lỗ", "số 25", "số 30", "lớn hơn"],
        image: null
    },
    {
        id: 70,
        jp: "きかいの スイッチは きかいを つかう ひとが そうさします。",
        romaji: "kikaino suicchi wa kikaiwo tsukau hitoga sousashimasu.",
        meaning: "Công tắc máy được vận hành bởi người sử dụng máy",
        answer: "◯",
        keywords: ["きかい", "スイッチ", "つかう", "そうさ", "kikai", "suicchi", "tsukau", "sousa", "công tắc máy", "vận hành", "sử dụng"],
        image: null
    },
    {
        id: 71,
